...
class SubscriptionManager:
    """Synchronizes ProviderManager with active trackings from database.

    Responsibilities:
    - Load active trackings from database periodically
    - Extract unique symbols that should be monitored
    - Call ProviderManager.sync() to update required symbols
    """
    ...
    async def _sync_subscriptions(self) -> None:
        """Load active trackings and synchronize required symbols."""
        try:
            ...
            # Delegate to ProviderManager for symbol set synchronization  
